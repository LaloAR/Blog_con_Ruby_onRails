...
RSpec.describe User, type: :model do
  ...
  # Agrupar pruebas por nombre del método
  describe "#validate_username_regex" do
  	# Retorna un usuario construido con FactoryGirl
  	let(:user){FactoryGirl.build(:user)}
  	it "should not allow username with numbers at the beginning" do
  		user.username = "987dasdsa"
  		# valid? => false
  		# errors => no esté vacío
  		# erros.full_messages => El username sólo puede contener guión bajo, letras y números
  		# falsy es falso o nulo
